...
$user_name = 'Катамаранов'; // укажите здесь ваше имя

$a1 = true;
$a =name_list;
$name_list = $a['Price'];
function form_price($a1, $a)
{
    round($a);
    if ($a >= 1000):
        number_format($a, 0, '.', ' ');
...
<main class="container">
    ...
    <section class="lots">
        ...
        <ul class="lots__list"><?php foreach($name_list as $key => $val): ?>
            <!--заполните этот список из массива с товарами-->
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src=<?php print ($val['image']); ?> width="350" height="260" alt=<?php print ($val['name']); ?>
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?php print $category_list[$val['category']]?></span>
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?php print $val['name']?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?php print ($val['price']); ?></b></span>
                        </div>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            ...
            <?php foreach  ($category_list as $key => $val):?>
                <li class="nav__item">
                    <a href="pages/all-lots.html"><? print $val ?></a>
                </li>
            <?php endforeach; ?>
        </ul>
    </nav>
